...
function restartGame() {
    ...
    allEnemies = [];
    allEnemies.push(
        new Enemy(0,30 + Math.random()*140,40 + Math.random()*100),
        new Enemy(0,70 + Math.random()*140,40 + Math.random()*100),
        new Enemy(0,40 + Math.random()*100,100 + Math.random()*100),
        new Enemy(0,30 + Math.random()*100,60 + Math.random()*100),
        new Enemy(5,50 + Math.random()*130,90 + Math.random()*100)
        );
}
